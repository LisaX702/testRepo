...
def get_scatter_plot(site_dropdown, payloadSldr):
    if site_dropdown == 'ALL':
        ...
        &(filtered_df['Payload Maxx (kg)']<=payload_slider[1])]
        scatterplot = px.scatter(filtered_df, x="Payload Maxx (kg)", y="class",  
        title='Payload Mass vs Success Outcomes',
        color="Booster Version Category")
        return scatterplot
